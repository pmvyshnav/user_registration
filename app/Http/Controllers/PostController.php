    ...
    public function store(Request $request)
    {
      ...
      require '../vendor/autoload.php';													// load Composer's autoloader
	    	...
	    	$mail->SMTPDebug = 0;                                	// Enable verbose debug output
				...
				$mail->Username = 'vyshnavgodlandit@gmail.com';             // SMTP username
				$mail->Password = 'godlandit';              // SMTP password
				$mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
				$mail->Port = 587;                                    // TCP port to connect to

				//Recipients
				$mail->setFrom('vyshnavgodlandit@gmail.com', 'User Registration');
				$mail->addAddress($email, 'Optional name');	// Add a recipient, Name is optional
				$mail->addReplyTo('vyshnavgodlandit@gmail.com', 'User Registration');
				$mail->addCC($email);
				$mail->addBCC($email);
